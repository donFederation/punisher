...
OUT;
        ...
        echo <<<OUT
				...
				<div id="topheader">
					<h1 id="title">
						<a href="{$self}">Punisher Admin Control Panel</a><br>
...
OUT;
		...
		<div id="footer">
			...
			<div id="footer_bg">
				<p><a href="http://www.ţ.com/">Punisher</a>&reg; &copy; 2007-2015 Punisher. All rights reserved.</p>
			</div>
